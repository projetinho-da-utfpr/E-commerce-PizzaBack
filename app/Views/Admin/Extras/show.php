    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php if($extra->deletado_em == null): ?>
                    <a href= "<?php echo site_url("admin/extras/editar/$extra->id"); ?>"class="btn btn-dark btn-sm btn-icon-text mr-2 btn-sm">
                        <i class="mdi mdi-file-check btn-icon-prepend"></i>
                        Editar
                    </a>

                    <a href= "<?php echo site_url("admin/extras/excluir/$extra->id"); ?>"class="btn btn-danger btn-sm mr-2 btn-sm">
