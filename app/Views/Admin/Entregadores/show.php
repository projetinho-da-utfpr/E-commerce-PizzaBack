        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-center">
                    ...
                    <?php else:?>
                        <img class="card-img-top w-75" src="<?php echo site_url('admin/images/produto-sem-imagem.jpg') ?>" alt="entregador sem imagem">
              ...
              <?php if($entregador->deletado_em == null):?>
                <a href= "<?php echo site_url("admin/entregadores/editarimagem/$entregador->id"); ?>"class="btn btn-outline-info mt-2 mb-2 btn-sm btn-icon-text">
              ...
              <?php endif; ?>
                ...
                <?php if($entregador->deletado_em == null): ?>
                    <a href= "<?php echo site_url("admin/entregadores/editar/$entregador->id"); ?>"class="btn btn-dark btn-sm btn-icon-text mr-2 btn-sm">
                        <i class="mdi mdi-file-check btn-icon-prepend"></i>
                        Editar
                    </a>


                    <a href= "<?php echo site_url("admin/entregadores/excluir/$entregador->id"); ?>"class="btn btn-danger btn-sm mr-2 btn-sm">
                        <i class="mdi mdi-delete btn-icon-prepend"></i>
                        Excluir
                    </a>

                    <a href= "<?php echo site_url("admin/entregadores"); ?>"class="btn btn-light  m2-2 text-dark btn-sm">
