    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <a href= "<?php echo site_url("admin/entregadores/criar"); ?>"class="btn btn-outline-success btn-fw float-right mb-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="py-1">
                                    ...
                                    <?php else: ?>
                                        <img src="<?php echo site_url('admin/images/produto-sem-imagem.jpg'); ?>" alt="Entregador sem imagem"/>
                                    <?php endif; ?>
