    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <div class="ui-widget">
                    <input id="query" name="query" placeholder="Pesquise por um bairro de Campo Mourão" class="form-control bg-light mb-5">
                </div>


                <a href= "<?php echo site_url("admin/bairros/criar"); ?>"class="btn btn-outline-success btn-fw float-right mb-5">
