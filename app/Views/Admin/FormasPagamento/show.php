            ...
            <div class="card-body">
                ...
                <?php if($forma->id == 1): ?>
                    <div class="alert alert-primary" role="alert">
                        ...
                        não pode ser <span class="text-danger">editada ou Excluída</span>, pois essa opção terá vinculada ou não o envio de troco para o cliente 
                ...
                <?php if($forma->deletado_em == null): ?>
                    ...
                    <?php if($forma->id != 1): ?>
                        <a href= "<?php echo site_url("admin/formas/editar/$forma->id"); ?>"class="btn btn-dark btn-sm btn-icon-text mr-2 btn-sm">
                            <i class="mdi mdi-file-check btn-icon-prepend"></i>
                            Editar
                        </a>

                        <a href= "<?php echo site_url("admin/formas/excluir/$forma->id"); ?>"class="btn btn-danger btn-sm mr-2 btn-sm">
